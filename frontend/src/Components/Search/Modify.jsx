...
function Modify() {
    ...
    // console.log('Updated state:', { keyword, dkeyword, date, returnDate, travellers });
    ...
    // Function to populate state from query parameters
    const usePopulateStateFromParams = () => {
        ...
        useEffect(() => {
            ...
            const returnDate = searchParams.get("rtnDate") || "";
            const tripType = searchParams.get("trpType") || "one-way";
            const adults = parseInt(searchParams.get("adults") || "1");
            const children = parseInt(searchParams.get("children") || "0");
            const infants = parseInt(searchParams.get("infants") || "0");
            const classR = searchParams.get("class") || "economy";
            const totalR = parseInt(searchParams.get("tpassenger") || "0");
            ...
            // Log values here to see the correct values when updated
            // console.log("Adults:", adults);
            // console.log("Children:", children);
            // console.log("Infants:", infants);
            // console.log("Total passengers:", totalR);
                        ...
                        <div className="col-12 col-lg-11 mt-4 m-auto">
                            ...
                            <form onSubmit={handleSearch}>
                                ...
                                <div className="row form_search_us align-items-center">
                                    ...
                                    <div className="col-6 col-md-3 col-lg-2 form_search_us_m">
                                        <div className="form_search_c">
                                            <label htmlFor=""><img src="/imgs/loc-iii.png" /> Depature</label>
                                            {/* <input
                                                type="date"
                                                id='dDate'
                                                value={date}
                                            ...
                                            <p className="small_de">DD/MMM/YYYY</p>
                                        </div>
                                    </div>
                                                ...
                                                <div className="passenger_mod_main">
                                                    ...
                                                    <div className="pass_container_1">
                                                        ...
                                                        <div className="pass_btnss d-flex">
                                                            <div
                                                                className="adult_min adult_min_flight"
                                                                onClick={() => {
                                                    ...
                                                    <div className="pass_container_1">
                                                        ...
                                                        <div className="pass_btnss d-flex">
                                                            <div
                                                                className="add_child_min add_child_min_flight"
                                                                onClick={() => {
